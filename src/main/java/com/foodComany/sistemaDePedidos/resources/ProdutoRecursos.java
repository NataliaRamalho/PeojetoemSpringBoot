...
import com.foodComany.sistemaDePedidos.services.ProdutoServices;
...
public class ProdutoRecursos {
	...
	@GetMapping
	public ResponseEntity<List<Produto>> ProcurarProdutos(){
		List<Produto> list = services.ProcurarProdutos();	
		return ResponseEntity.ok().body(list);
	}
	
	@GetMapping(value = "/{id}")
	public ResponseEntity<Produto> findById(@PathVariable Long id){
		Produto obj = services.findyById(id);
	...
	public ResponseEntity<Produto> inserirProduto(@RequestBody Produto obj){ 
		obj = services.inserirProduto(obj);
	...
	public ResponseEntity<Produto> atualizar(@PathVariable Long id,@RequestBody Produto obj){
		obj = services.atualizarProduto(id, obj);
		return ResponseEntity.ok().body(obj);
	}
}
